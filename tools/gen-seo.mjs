...
const DESCRIPTION = 'How modern Windows builds an unbroken, verifiable chain of trust from silicon to cloud, and where attackers break it. An open, evidence-based technical book.';
